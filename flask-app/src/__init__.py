...
def create_app():
    ...
    # changed db_password to db_root_password, 
    # but shouldn't matter since they are the same password
    app.config['MYSQL_DATABASE_PASSWORD'] = open('/secrets/db_root_password.txt').readline()
    app.config['MYSQL_DATABASE_HOST'] = 'db'
    app.config['MYSQL_DATABASE_PORT'] = 3306
    app.config['MYSQL_DATABASE_DB'] = 'proprojectsdb'  # Change this to your DB name
